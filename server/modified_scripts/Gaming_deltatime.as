package
{
   ...
   [SWF(frameRate="120",backgroundColor="#000000",width="950",height="600")]
   public class Gaming extends MovieClip
   {
      ...
      // Delta-time accumulator for fixed-step logic at high FPS
      private var _lastTime:Number = 0;
      private var _accumulator:Number = 0;
      private static const LOGIC_DT:Number = 1000.0 / 30.0;
